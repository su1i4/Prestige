...
const HighlightPath = ({ d, isActive, x, y, width, height, onMouseEnter, onClick, scale }) => (
  <svg
    x={x}
    y={y}
    width={width}
...
export const Floors = () => {
  ...
  console.log(thisFloor.squints[String(activeFloorIndex + 1)].name, 'this is floorIndex')
  ...
  return (
    <div className="w-full px-10">
      ...
      <Application square={thisFloor.squints[String(activeFloorIndex + 1)].square} lock={thisFloor.squints[String(activeFloorIndex + 1)].lock} name={thisFloor.squints[String(activeFloorIndex + 1)].name} />
    </div>
  );
};
